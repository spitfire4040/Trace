...
int main(int argc, char *argv[])
{
	...
	// set file name
	inFileName1 = "/home/jay/Desktop/Trace_01/MlabData/unique_trace_" + month + "_" + day + "_" + year + ".txt"; // unique_trace
	inFileName2 = "/home/jay/Desktop/Trace_01/MlabData/all_trace_" + month + "_" + day + "_" + year + ".txt"; // all_trace
	outFileName = "/home/jay/Desktop/Trace_01/MlabData/tracecount_" + month + "_" + day + "_" + year + ".txt"; // trace_count
